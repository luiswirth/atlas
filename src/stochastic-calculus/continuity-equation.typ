...
and $integral div avec(J) = 0$ gives preservation of probability.
...
The nonlinear operations are what fail,
...
The joint is the primitive object, and conditioning disintegrates it.
...
and KL is its expected logarithm.
